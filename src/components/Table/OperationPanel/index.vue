<template>
  <div class="plan">
    <el-button type="primary" size="mini" icon="el-icon-search" class="filter-item" style="margin-right: 10px;" @click="addForm">{{ addName }}</el-button>
    <div v-if="showTableCloumns" class="table-cloumns filter-item">
